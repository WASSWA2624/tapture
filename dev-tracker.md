...
**11 of 281 tasks complete (3.9%)** · last updated 2026-09-09
...
| :--- | ---: | ---: | :--- |
| 01 — Project setup and guardrails | 11 | 18 | `█████████░░░░░` 61% |
...
- [ ] [019 — Application bootstrap, flavours and lifecycle](dev-plan/02-foundation/019-app-bootstrap.md)
- [ ] [020 — Shared constants](dev-plan/02-foundation/020-app-constants.md)
...
- [ ] [030 — Design tokens: colour, type, spacing and elevation](dev-plan/03-design-system/030-color-tokens.md)
