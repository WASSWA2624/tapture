# 108 — Processing: on-device first, online only when it earns its place

**Phase** 13 · Processing  |  **Depends on** [024](../02-foundation/024-hashing-service.md), [029](../02-foundation/029-ai-service-interface.md), [057](../04-data-layer/057-jobs-table.md), [062](../04-data-layer/062-repository-interfaces.md), [078](../07-account-and-settings/078-settings-store.md), [088](../09-templates/088-template-model.md), [089](../09-templates/089-field-type-registry.md), [104](../09-templates/104-template-detection-profile.md), [105](../10-reference-data/105-reference-data.md), [107](../12-capture/107-capture.md)  |  **Standard** [STANDARD.md](../STANDARD.md)
