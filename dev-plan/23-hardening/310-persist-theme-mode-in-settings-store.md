# 310 — Persist the theme mode in the settings store

**Phase** 23 · Hardening  |  **Depends on** [031](../03-design-system/031-theme-assembly.md), [078](../07-account-and-settings/078-settings-store.md)  |  **Standard** [STANDARD.md](../STANDARD.md)
