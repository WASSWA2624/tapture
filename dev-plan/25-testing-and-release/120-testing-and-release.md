# 120 — Testing and release: the suites, the pipeline and the gate over both artefacts

**Phase** 25 · Testing and release  |  **Depends on** [049](../04-data-layer/049-drift-setup.md), [062](../04-data-layer/062-repository-interfaces.md), [107](../12-capture/107-capture.md), [110](../15-data-quality/110-data-quality.md), [112](../17-meetings/112-meetings.md), [113](../18-export/113-export.md), [114](../19-bundles-and-merge/114-bundles-and-merge.md), [117](../22-privacy-and-security/117-privacy-and-security.md), [118](../23-hardening/118-hardening.md), [119](../24-backend/119-minimal-backend.md)  |  **Standard** [STANDARD.md](../STANDARD.md)
