# 114 — Bundles and merge: a project leaves whole and rejoins safely

**Phase** 19 · Bundles and merge  |  **Depends on** [015](../01-orchestration/015-logging-checker.md), [027](../02-foundation/027-secure-storage-service.md), [050](../04-data-layer/050-column-mixins.md), [051](../04-data-layer/051-tombstones-table.md), [054](../04-data-layer/054-records-table.md), [055](../04-data-layer/055-photos-table.md), [061](../04-data-layer/061-merge-tables.md), [071](../05-file-storage/071-file-validation.md), [084](../08-projects/084-project-create.md), [113](../18-export/113-export.md)  |  **Standard** [STANDARD.md](../STANDARD.md)
