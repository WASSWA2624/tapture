...
abstract final class TemplateAssets {
  ...
  /// Index of the full catalogue: supergroups, categories, record types and
  /// the asset of each category. Generated by
  /// `tool/build_template_catalogue.dart`.
  static const String catalogueIndex =
      'assets/templates/catalogue/_catalogue.json';

  /// The category context and record-type pack groups catalogue templates
  /// inherit beside the four of §13.3.
  static const String catalogueGroups =
      'assets/templates/catalogue/_groups.json';
