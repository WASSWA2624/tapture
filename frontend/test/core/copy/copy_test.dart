...
List<String> get _values {
  return <String>[
    ...
    Copy.shippedCatalogueCategoryTitle('UNI', 'Universal capture and records'),
    Copy.shippedCatalogueSubtitle('UNI-001', 'Observation', 67),
    Copy.shippedFiltersTitle,
    Copy.shippedAreaFilter,
    Copy.shippedRecordTypeFilter,
    Copy.shippedTierFilter,
    Copy.shippedTierLabel('p0'),
    Copy.shippedTierLabel('p1'),
    Copy.shippedTierLabel('p2'),
    Copy.shippedPrivacyLabel('internal'),
    Copy.shippedPrivacyLabel('confidential'),
    Copy.shippedPrivacyLabel('restricted'),
    Copy.shippedCategoryLabel,
    Copy.shippedRecordTypeLabel,
    Copy.shippedPrivacyTierLabel,
    Copy.shippedCaptureLabel,
    Copy.shippedAiAssistanceLabel,
    Copy.shippedOutputsLabel,
    Copy.shippedReviewLabel,
    Copy.shippedFieldSubtitle('text', Copy.fieldRequired),
    Copy.shippedLabel('templates.catalogue.observation_subject'),
    Copy.navQueue,
    Copy.navExports,
